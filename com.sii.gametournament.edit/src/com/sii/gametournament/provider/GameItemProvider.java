...
/**
 * This is the item provider adapter for a {@link com.sii.gametournament.Game} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GameItemProvider 
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Game_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Game_type_feature", "_UI_Game_type"),
				 GametournamentPackage.Literals.GAME__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Game.class)) {
			case GametournamentPackage.GAME__NAME:
			case GametournamentPackage.GAME__TYPE:
