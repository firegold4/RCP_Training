 ...
 * </p>
 * <ul>
 *   <li>{@link com.sii.gametournament.impl.QualificationPhaseImpl#getPools <em>Pools</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QualificationPhaseImpl extends MinimalEObjectImpl.Container implements QualificationPhase {
	/**
	 ...
	 * @generated
	 */
	protected QualificationPhaseImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GametournamentPackage.Literals.QUALIFICATION_PHASE;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GametournamentPackage.QUALIFICATION_PHASE__POOLS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case GametournamentPackage.QUALIFICATION_PHASE___CREATE_POOLS:
				return createPools();
		}
		return super.eInvoke(operationID, arguments);
	}

} //QualificationPhaseImpl
