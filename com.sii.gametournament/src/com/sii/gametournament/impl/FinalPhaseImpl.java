 ...
 * </p>
 * <ul>
 *   <li>{@link com.sii.gametournament.impl.FinalPhaseImpl#getFinalists <em>Finalists</em>}</li>
 *   <li>{@link com.sii.gametournament.impl.FinalPhaseImpl#getQualificationphase <em>Qualificationphase</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FinalPhaseImpl extends MinimalEObjectImpl.Container implements FinalPhase {
	/**
	...
	protected EClass eStaticClass() {
		return GametournamentPackage.Literals.FINAL_PHASE;
	}
		...
		if (qualificationphase != null && qualificationphase.eIsProxy()) {
			...
			if (qualificationphase != oldQualificationphase) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GametournamentPackage.FINAL_PHASE__QUALIFICATIONPHASE, oldQualificationphase, qualificationphase));
			}
		}
	...
	public void setQualificationphase(QualificationPhase newQualificationphase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GametournamentPackage.FINAL_PHASE__QUALIFICATIONPHASE, oldQualificationphase, qualificationphase));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GametournamentPackage.FINAL_PHASE__FINALISTS:
				return getFinalists();
			case GametournamentPackage.FINAL_PHASE__QUALIFICATIONPHASE:
